...
epicsShareExtern void (*pvar_func_register_func_subLVInit)(void);
epicsShareExtern void (*pvar_func_register_func_subLVProcess)(void);
epicsShareExtern void (*pvar_func_register_func_subTempInit)(void);
epicsShareExtern void (*pvar_func_register_func_subTempProcess)(void);
epicsShareExtern void (*pvar_func_register_func_subPollInit)(void);
...
{
    const char *bldTop = "/mnt/host/daq/epics/svt-epics/example";
    ...
    (*pvar_func_register_func_subLVInit)();
    (*pvar_func_register_func_subLVProcess)();
    (*pvar_func_register_func_subTempInit)();
    (*pvar_func_register_func_subTempProcess)();
    (*pvar_func_register_func_subPollInit)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"myexample_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    myexample_registerRecordDeviceDriver(*iocshPpdbbase);
}
