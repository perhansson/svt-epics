...
/* Generated from ../O.Common/HVCAENx527.dbd */
...
static const char * const deviceSupportNames[52] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[52] = {
...
int HVCAENx527_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    registerDevices(pbase, 52, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"HVCAENx527_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    HVCAENx527_registerRecordDeviceDriver(*iocshPpdbbase);
}
