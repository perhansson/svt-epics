...
/* Generated from ../O.Common/dummy.dbd */
...
int dummy_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"dummy_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    dummy_registerRecordDeviceDriver(*iocshPpdbbase);
}
